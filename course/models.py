...
class Level(models.Model):
    ...
    level_short_name = models.CharField(max_length=10, blank=True, null=True)
...
class Course(models.Model):
    ...
    course_short_name = models.CharField(max_length=10, blank=True, null=True)
...
class Module(models.Model):
    ...
    module_short_name = models.CharField(max_length=10, blank=True, null=True)
...
class Unit(models.Model):
    ...
    unit_short_name = models.CharField(max_length=10, blank=True, null=True)
